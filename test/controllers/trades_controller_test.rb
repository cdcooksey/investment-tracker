...
class TradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post trades_url, params: { trade: { amount: @trade.amount, ticker_id: @trade.ticker_id, user_id: @trade.user_id } }
    end
  ...
  test "should update trade" do
    patch trade_url(@trade), params: { trade: { amount: @trade.amount, ticker_id: @trade.ticker_id, user_id: @trade.user_id } }
